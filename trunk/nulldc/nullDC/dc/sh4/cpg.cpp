...
void cpg_Init()
{
	...
	CPG[(CPG_FRQCR_addr&0xFF)>>2].NextCange=0;
	...
	CPG[(CPG_STBCR_addr&0xFF)>>2].NextCange=0;
	...
	CPG[(CPG_WTCNT_addr&0xFF)>>2].NextCange=0;
	...
	CPG[(CPG_WTCSR_addr&0xFF)>>2].NextCange=0;
	...
	CPG[(CPG_STBCR2_addr&0xFF)>>2].NextCange=0;
