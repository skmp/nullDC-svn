...
sh4_opcodelistentry opcodes[]=
{
	...
	{rec_shil_icpu_nimp	,i0000_nnnn_0010_0011	,Mask_n		,0x0023	,BranchDelay_u_UsePC,OpDissCFS,"braf <REG_N>"},	//braf <REG_N>                  
	{rec_shil_icpu_nimp	,i0000_nnnn_0000_0011	,Mask_n		,0x0003	,BranchDelay_u_UsePC,OpDissCFS,"bsrf <REG_N>"},	//bsrf <REG_N>                  
	...
	{rec_shil_i0000_0000_0000_1001	,i0000_0000_0000_1001	,Mask_none	,0x0009	,NoOperation		,OpDissCFS,"nop"},	//nop                           
	...
	{rec_shil_icpu_nimp	,i0000_0000_0010_1011	,Mask_none	,0x002B	,BranchDelay_u		,OpDissCFS,"rte"},	//rte                           
	{rec_shil_icpu_nimp	,i0000_0000_0000_1011	,Mask_none	,0x000B	,BranchDelay_u		,OpDissCFS,"rts"},	//rts                           
	{rec_shil_icpu_nimp	,i0000_0000_0001_1011	,Mask_none	,0x001B	,Branch_u_UsePC		,OpDissCFS,"sleep"},	//sleep                         
	...
	{rec_shil_icpu_nimp	,i0100_nnnn_0000_0111	,Mask_n		,0x4007	,SystemSt				,OpDissCFS,"ldc.l @<REG_N>+,SR"},	//ldc.l @<REG_N>+,SR            
	...
	{rec_shil_icpu_nimp	,i0100_nnnn_0000_1110	,Mask_n		,0x400E	,SystemSt			,OpDissCFS,"ldc <REG_N>,SR"},	//ldc <REG_N>,SR                
	...
	{rec_shil_icpu_nimp	,i0100_nnnn_0010_1011	,Mask_n		,0x402B	,BranchDelay_u		,OpDissCFS,"jmp @<REG_N>"},		//jmp @<REG_N>                  
	{rec_shil_icpu_nimp	,i0100_nnnn_0000_1011	,Mask_n		,0x400B	,BranchDelay_u_UsePC,OpDissCFS,"jsr @<REG_N>"},	//jsr @<REG_N>                  
	...
	{rec_shil_icpu_nimp	,i1000_1011_iiii_iiii	,Mask_imm8	,0x8B00	,Branch_c_UsePC		,OpDissCFS,"bf <bdisp8>"},	// bf <bdisp8>                   
	{rec_shil_icpu_nimp	,i1000_1111_iiii_iiii	,Mask_imm8	,0x8F00	,BranchDelay_c_UsePC,OpDissCFS,"bf.s <bdisp8>"},	// bf.s <bdisp8>                 
	{rec_shil_icpu_nimp	,i1000_1001_iiii_iiii	,Mask_imm8	,0x8900	,Branch_c_UsePC		,OpDissCFS,"bt <bdisp8>"},	// bt <bdisp8>                   
	{rec_shil_icpu_nimp	,i1000_1101_iiii_iiii	,Mask_imm8	,0x8D00	,BranchDelay_c_UsePC,OpDissCFS,"bt.s <bdisp8>"},	// bt.s <bdisp8>                 
	...
	{rec_shil_i1001_nnnn_iiii_iiii	,i1001_nnnn_iiii_iiii	,Mask_n_imm8,0x9000	,Normal_needpc		,OpDissCFS,"mov.w @(<PCdisp8>),<REG_N>"},	//mov.w @(<disp>,PC),<REG_N>   
	{rec_shil_icpu_nimp	,i1010_iiii_iiii_iiii	,Mask_n_imm8,0xA000	,BranchDelay_u_UsePC,OpDissCFS,"bra <bdisp12>"},	// bra <bdisp12>
	{rec_shil_icpu_nimp	,i1011_iiii_iiii_iiii	,Mask_n_imm8,0xB000	,BranchDelay_u_UsePC,OpDissCFS,"bsr <bdisp12>"},	// bsr <bdisp12>
	...
	{rec_shil_icpu_nimp	,i1100_0011_iiii_iiii	,Mask_imm8	,0xC300	,Branch_u_UsePC		,OpDissCFS,"trapa #<imm8>"},	// trapa #<imm>                  
	...
	{rec_shil_i1100_0111_iiii_iiii	,i1100_0111_iiii_iiii	,Mask_imm8	,0xC700	,Normal_needpc		,OpDissCFS,"mova @(<PCdisp8>),R0"},	// mova @(<disp>,PC),R0          
	...
	{rec_shil_i1101_nnnn_iiii_iiii	,i1101_nnnn_iiii_iiii	,Mask_n_imm8,0xD000	,Normal_needpc		,OpDissCFS,"mov.l @(<PCdisp8>),<REG_N>"},	// mov.l @(<disp>,PC),<REG_N>    
	...
	{rec_shil_i1111_nnnn_mmmm_0000	,i1111_nnnn_mmmm_0000	,Mask_n_m		,0xF000,Arithm_FPU		,d1111_nnnn_mmmm_0000},	//fadd <FREG_M>,<FREG_N>
	{rec_shil_i1111_nnnn_mmmm_0001	,i1111_nnnn_mmmm_0001	,Mask_n_m		,0xF001,Arithm_FPU		,d1111_nnnn_mmmm_0001},	//fsub <FREG_M>,<FREG_N>   
	{rec_shil_i1111_nnnn_mmmm_0010	,i1111_nnnn_mmmm_0010	,Mask_n_m		,0xF002,Arithm_FPU		,d1111_nnnn_mmmm_0010},	//fmul <FREG_M>,<FREG_N>   
	{rec_shil_i1111_nnnn_mmmm_0011	,i1111_nnnn_mmmm_0011	,Mask_n_m		,0xF003,Arithm_FPU		,d1111_nnnn_mmmm_0011},	//fdiv <FREG_M>,<FREG_N>   
	{rec_shil_i1111_nnnn_mmmm_0100	,i1111_nnnn_mmmm_0100	,Mask_n_m		,0xF004,Arithm_FPU		,d1111_nnnn_mmmm_0100},	//fcmp/eq <FREG_M>,<FREG_N>
	{rec_shil_i1111_nnnn_mmmm_0101	,i1111_nnnn_mmmm_0101	,Mask_n_m		,0xF005,Arithm_FPU		,d1111_nnnn_mmmm_0101},	//fcmp/gt <FREG_M>,<FREG_N>
	{rec_shil_i1111_nnnn_mmmm_0110	,i1111_nnnn_mmmm_0110	,Mask_n_m		,0xF006,Arithm_FPU		,d1111_nnnn_mmmm_0110},	//fmov.s @(R0,<REG_M>),<FREG_N>
	{rec_shil_i1111_nnnn_mmmm_0111	,i1111_nnnn_mmmm_0111	,Mask_n_m		,0xF007,Arithm_FPU		,d1111_nnnn_mmmm_0111},	//fmov.s <FREG_M>,@(R0,<REG_N>)
	{rec_shil_i1111_nnnn_mmmm_1000	,i1111_nnnn_mmmm_1000	,Mask_n_m		,0xF008,Arithm_FPU		,d1111_nnnn_mmmm_1000},	//fmov.s @<REG_M>,<FREG_N> 
	{rec_shil_i1111_nnnn_mmmm_1001	,i1111_nnnn_mmmm_1001	,Mask_n_m		,0xF009,Arithm_FPU		,d1111_nnnn_mmmm_1001},	//fmov.s @<REG_M>+,<FREG_N>
	{rec_shil_i1111_nnnn_mmmm_1010	,i1111_nnnn_mmmm_1010	,Mask_n_m		,0xF00A,Arithm_FPU		,d1111_nnnn_mmmm_1010},	//fmov.s <FREG_M>,@<REG_N>
	{rec_shil_i1111_nnnn_mmmm_1011	,i1111_nnnn_mmmm_1011	,Mask_n_m		,0xF00B,Arithm_FPU		,d1111_nnnn_mmmm_1011},	//fmov.s <FREG_M>,@-<REG_N>
	{rec_shil_i1111_nnnn_mmmm_1100	,i1111_nnnn_mmmm_1100	,Mask_n_m		,0xF00C,Arithm_FPU		,d1111_nnnn_mmmm_1100},	//fmov <FREG_M>,<FREG_N>   
	{rec_shil_i1111_nnnn_0101_1101	,i1111_nnnn_0101_1101	,Mask_n			,0xF05D,Arithm_FPU		,d1111_nnnn_0101_1101},	//fabs <FREG_N>            
	{rec_shil_i1111_nnn0_1111_1101	,i1111_nnn0_1111_1101	,Mask_nh3bit	,0xF0FD,Arithm_FPU		,OpDissFSCA},	//FSCA FPUL, DRn//F0FD//1111_nnnn_1111_1101
	{rec_shil_i1111_nnnn_1011_1101	,i1111_nnnn_1011_1101	,Mask_n			,0xF0BD,Arithm_FPU		,d1111_nnnn_1011_1101},	//fcnvds <DR_N>,FPUL       
	{rec_shil_i1111_nnnn_1010_1101	,i1111_nnnn_1010_1101	,Mask_n			,0xF0AD,Arithm_FPU		,d1111_nnnn_1010_1101},	//fcnvsd FPUL,<DR_N>       
	{rec_shil_i1111_nnmm_1110_1101	,i1111_nnmm_1110_1101	,Mask_n			,0xF0ED,Arithm_FPU		,OpDissfipr},	//fipr <FV_M>,<FV_N>            
	{rec_shil_i1111_nnnn_1000_1101	,i1111_nnnn_1000_1101	,Mask_n			,0xF08D,Arithm_FPU		,d1111_nnnn_1000_1101},	//fldi0 <FREG_N>           
	{rec_shil_i1111_nnnn_1001_1101	,i1111_nnnn_1001_1101	,Mask_n			,0xF09D,Arithm_FPU		,d1111_nnnn_1001_1101},	//fldi1 <FREG_N>           
	{rec_shil_i1111_nnnn_0001_1101	,i1111_nnnn_0001_1101	,Mask_n			,0xF01D,Arithm_FPU		,d1111_nnnn_0001_1101},	//flds <FREG_N>,FPUL       
	{rec_shil_i1111_nnnn_0010_1101	,i1111_nnnn_0010_1101	,Mask_n			,0xF02D,Arithm_FPU		,d1111_nnnn_0010_1101},	//float FPUL,<FREG_N>      
	{rec_shil_i1111_nnnn_0100_1101	,i1111_nnnn_0100_1101	,Mask_n			,0xF04D,Arithm_FPU		,d1111_nnnn_0100_1101},	//fneg <FREG_N>            
	{rec_shil_i1111_1011_1111_1101	,i1111_1011_1111_1101	,Mask_none		,0xFBFD,Arithm_FPU		,OpDissCFS,"frchg"},	//frchg                    
	{rec_shil_i1111_0011_1111_1101	,i1111_0011_1111_1101	,Mask_none		,0xF3FD,Arithm_FPU		,OpDissCFS,"fschg"},	//fschg                    
	{rec_shil_i1111_nnnn_0110_1101	,i1111_nnnn_0110_1101	,Mask_n			,0xF06D,Arithm_FPU		,d1111_nnnn_0110_1101},	//fsqrt <FREG_N>                
	{rec_shil_i1111_nnnn_0011_1101	,i1111_nnnn_0011_1101	,Mask_n			,0xF03D,Arithm_FPU		,d1111_nnnn_0011_1101},	//ftrc <FREG_N>, FPUL      
	{rec_shil_i1111_nnnn_0000_1101	,i1111_nnnn_0000_1101	,Mask_n			,0xF00D,Arithm_FPU		,d1111_nnnn_0000_1101},	//fsts FPUL,<FREG_N>       
	{rec_shil_i1111_nn01_1111_1101	,i1111_nn01_1111_1101	,Mask_nh2bit	,0xF1FD,Arithm_FPU		,OpDissftrv},	//ftrv xmtrx,<FV_N> 
	{rec_shil_i1111_nnnn_mmmm_1110	,i1111_nnnn_mmmm_1110	,Mask_n_m		,0xF00E,Arithm_FPU		,OpDissfmac},	//fmac <FREG_0>,<FREG_M>,<FREG_N> 
	{rec_shil_i1111_nnnn_0111_1101	,i1111_nnnn_0111_1101	,Mask_n			,0xF07D,Arithm_FPU		,d1111_nnnn_0111_1101},	//FSRRA <FREG_N> (1111nnnn 01111101)
