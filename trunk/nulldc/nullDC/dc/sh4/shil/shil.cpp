...
{
//	emit(shil_opcodes::readm,to,from,FLAG_8);
	//if (sx)
	//	emit(shil_opcodes::movex,to,from,FLAG_SX);
}
void shil_stream::readm16(Sh4RegType to,Sh4RegType from,bool sx)
{
	//emit(shil_opcodes::readm,to,from,FLAG_16);
	//if (sx)
	//	emit(shil_opcodes::movex,to,from,FLAG_SX);
}
void shil_stream::readm32(Sh4RegType to,Sh4RegType from)
{
	//emit(shil_opcodes::readm,to,from,FLAG_32);
}
...
{
	emit32(shil_opcodes::SaveT,cond);
}
void shil_stream::LoadT(x86_flags to)
{
	emit32(shil_opcodes::LoadT,to);
}
