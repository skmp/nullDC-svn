...
void rtc_Init()
{
	...
	RTC[(RTC_RSECCNT_addr&0xFF)>>2].NextCange=0;
	...
	RTC[(RTC_RMINCNT_addr&0xFF)>>2].NextCange=0;
	...
	RTC[(RTC_RHRCNT_addr&0xFF)>>2].NextCange=0;
	...
	RTC[(RTC_RWKCNT_addr&0xFF)>>2].NextCange=0;
	...
	RTC[(RTC_RDAYCNT_addr&0xFF)>>2].NextCange=0;
	...
	RTC[(RTC_RMONCNT_addr&0xFF)>>2].NextCange=0;
	...
	RTC[(RTC_RYRCNT_addr&0xFF)>>2].NextCange=0;
	...
	RTC[(RTC_RSECAR_addr&0xFF)>>2].NextCange=0;
	...
	RTC[(RTC_RMINAR_addr&0xFF)>>2].NextCange=0;
	...
	RTC[(RTC_RHRAR_addr&0xFF)>>2].NextCange=0;
	...
	RTC[(RTC_RWKAR_addr&0xFF)>>2].NextCange=0;
	...
	RTC[(RTC_R64CNT_addr&0xFF)>>2].flags=REG_8BIT_READWRITE | REG_READ_DATA | REG_WRITE_DATA;
	RTC[(RTC_RDAYAR_addr&0xFF)>>2].NextCange=0;
	...
	RTC[(RTC_RMONAR_addr&0xFF)>>2].NextCange=0;
	...
	RTC[(RTC_RCR1_addr&0xFF)>>2].NextCange=0;
	...
	RTC[(RTC_RCR2_addr&0xFF)>>2].NextCange=0;
