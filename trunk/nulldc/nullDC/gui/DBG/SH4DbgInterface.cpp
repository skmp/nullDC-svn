...
////////////////////
char szDisBuf[256];////////
char *SH4DebugInterface::disasm(unsigned int address) 
{
...
char *SH4DebugInterface::getDescription(unsigned int address) 
{
	static u32 last=0;
	if( last==address )
		return szDesc;
	...
	u32 sz=sprintf(szDesc, "0x%04X      ", dwOp);
